...
// Just a simple simulation of a bouncing ball with ASCII Art rendering in the
// terminal cc -o ball ball.c && ./ball
...
static_assert(HEIGHT % 2 == 0,
              "If the amount of display rows is not divisible by 2 we can't "
              "properly compress it. See show(void) function");
